# Project EGO — Eador Genesis reverse-engineering handoff

**Status:** documentation checkpoint after `closer_inspection_1.txt` through `closer_inspection_11.txt`  
**Canonical runtime schema:** `eador_runtime_v14.h`  
**Stable import target:** `eador_runtime.h`  
...
```text
include/legacy/eador_runtime.h
docs/reverse-engineering/eador_genesis_runtime_handoff.md
docs/reverse-engineering/function_map.csv
docs/reverse-engineering/open_questions.md
```
...
eador_runtime_v14.h
eador_runtime.h
eador_runtime_v14_changes.txt
```

The two headers were generated from identical bytes and passed 32-bit syntax and established-size assertions.
...
typedef struct EadorUnitInstancePartial {
    ...
    eador_u8  unknown_04[4];            /* +0x04 */
    eador_s32 current_life;             /* +0x08 */
...
1. Read this document and `eador_runtime.h` before opening new functions.
