...
This is the frozen binary-analysis input to `DELIB-0001`, captured on
2026-08-04 from `docs/FIDELITY_AND_MODDABILITY_BINARY_VIEW.md`.

Do not update this snapshot when the canonical working position changes.
